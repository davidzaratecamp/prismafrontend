...
/** Cuándo entran las llamadas: 7 filas (día de semana) × 24 columnas (hora de Bogotá). */
    ...
    <Card>
      <CardHeader>
        <div className="flex flex-wrap items-baseline justify-between gap-2">
          <CardTitle className="text-base">Llamadas por hora y día</CardTitle>
          ...
          <div className="overflow-x-auto">
            <div className="min-w-[560px]" onMouseLeave={() => setHover(null)}>
              ...
              <p className="mt-2 text-[11px] text-muted-foreground">
                Hora de Bogotá (UTC−5) · máx. {max.toLocaleString('es-CO')} llamadas en una celda
              </p>
            </div>
          </div>
        )}
